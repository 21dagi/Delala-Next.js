...
const Header: React.FC = () => {
  ...
  return (
    <header className="h-16 w-full flex items-center relative justify-end px-5 space-x-10  flex justify-between items-center bg-white">
        
    <h1 className="text-xl text-white-800 font-bold">Delala</h1>
