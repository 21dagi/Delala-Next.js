...
function Profile() {
    ...
    const handleItemClick = (productId: number) => {
        router.push(`/agents/${productId}`); // Redirect to the dynamic route
    };
...
<div className="max-h-[75vh] overflow-y-auto">
    ...
    <li className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow" onClick={() => handleItemClick(1)}>
      ...
      <div>
        <div className="-mt-px flex divide-x divide-gray-200">
          ...
          <div className="-ml-px flex w-0 flex-1">
            <a href="tel:+2519-09-098-98" className="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border border-transparent py-4 text-sm font-semibold text-gray-900">
              <svg className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
